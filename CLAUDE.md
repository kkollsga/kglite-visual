...
> `?deterministic=1` switch the e2e/bench suites pass — and drills into it, a versioned binary protocol (v10)
...
> `/mcp` on the running instance** — twenty-seven tools an agent uses to show,
