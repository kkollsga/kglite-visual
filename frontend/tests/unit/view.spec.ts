...
function seeded(): SlotView {
  ...
  view.applySlice(
    slice({
      first_slot: 2,
      nodes: [
        { slot: 2, node_id: 100, handle: { generation: 'test-generation', node_id: 100 }, typed_key: { state: 'null' }, node_type: 'Person', title: 'ada', key: null },
        { slot: 3, node_id: 101, handle: { generation: 'test-generation', node_id: 101 }, typed_key: { state: 'null' }, node_type: 'Person', title: 'linus', key: null },
        { slot: 4, node_id: 102, handle: { generation: 'test-generation', node_id: 102 }, typed_key: { state: 'null' }, node_type: 'Person', title: '', key: null },
      ],
      slot_count: 5,
    }),
    null,
...
test('re-expanding after a collapse revives the slot the server chose', () => {
  ...
  view.applySlice(
    slice({
      first_slot: 5,
      nodes: [{ slot: 5, node_id: 100, handle: { generation: 'test-generation', node_id: 100 }, typed_key: { state: 'null' }, node_type: 'Person', title: 'ada', key: null }],
      slot_count: 6,
      tombstone_count: 1,
    }),
    null,
...
test('a slice that both adds nodes and compacts lands them at their new slots', () => {
  ...
  view.applySlice(
    slice({
      first_slot: 5,
      nodes: [
        { slot: 5, node_id: 200, handle: { generation: 'test-generation', node_id: 200 }, typed_key: { state: 'null' }, node_type: 'Person', title: 'grace', key: null },
        { slot: 6, node_id: 201, handle: { generation: 'test-generation', node_id: 201 }, typed_key: { state: 'null' }, node_type: 'Person', title: 'alan', key: null },
      ],
      slot_count: 5,
      tombstone_count: 0,
    }),
