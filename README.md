...
attaching an agent is pointing it at a URL. Twenty tools act on **one shared
...
- **[Agents and MCP](https://kglite-visual.readthedocs.io/en/latest/agents.html)** — the launch contract, the JSON twin, the twenty tools, `window.__kglv`, and what an agent may claim about a screen it cannot see.
